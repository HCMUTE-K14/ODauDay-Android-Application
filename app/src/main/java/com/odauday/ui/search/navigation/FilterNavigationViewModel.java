...
import com.odauday.ui.search.common.view.tagdialog.TagTypeDialogTagRecent;
    ...
    public void showTypePickerDialog(FilterOption option) {
        ...
        switch (option) {
            case PROPERTY_TYPE:
                ...
                break;
            case TAGS:
                List<Tag> selectedTag = new ArrayList<>(Arrays.asList(new Tag("20", "Gym"),
                          new Tag("2", "Balcony / Deck")));
                
                List<Tag> recentTags = new ArrayList<>(Arrays.asList(new Tag("20", "Gym"),
                          new Tag("2", "Balcony / Deck")));
                
                dialog = TagTypeDialogTagRecent
