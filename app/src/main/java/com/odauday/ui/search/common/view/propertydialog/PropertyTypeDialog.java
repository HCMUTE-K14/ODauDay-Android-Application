...
public class PropertyTypeDialog extends BaseDialogFragment {
    ...
    public static final String INTENT_EXTRA_SELECTED_PROPERTY_TYPE = "selected_property_type";
    ...
    public static PropertyTypeDialog newInstance(List<Integer> selectedProperty) {
        ...
        bundle
            .putIntegerArrayList(INTENT_EXTRA_SELECTED_PROPERTY_TYPE, (ArrayList) selectedProperty);
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        setPositiveButton(getString(R.string.txt_done), (dialog, which) -> {
