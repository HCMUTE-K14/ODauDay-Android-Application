...
public class FragmentConfirmProperty extends BaseMVVMFragment<FragmentConfirmPropertyBinding> implements ConfirmPropertyContract{
    ...
    private void getData(){
        mConfirmPropertyModel.getPropertyByAdmin(String.valueOf(numPage),String.valueOf(mLimit),mStatus,mLikeName);
    }
    ...
    public void onFailure(Exception ex) {
        ...
        if(mConfirmPropertyAdapter.getItemCount()<1){
            if (ex instanceof RetrofitException) {
                ...
                SnackBarUtils.showSnackBar(mBinding.get().confirmProperty, getString(R.string.message_service_unavailable));
            } else {
                mRecyclerView.setAdapter(mEmptyPropertyAdapter);
            }
        }
