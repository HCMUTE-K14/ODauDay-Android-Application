...
public class CircleImageView extends ImageView {
    ...
    public void setScaleType(ScaleType scaleType) {
        if (scaleType != SCALE_TYPE) {
            String errorMessage = String.format("ScaleType %s not supported.", scaleType);
    ...
    /**
     * Set a color to be drawn behind the circle-shaped drawable. Note that this has no effect if
     * the drawable is opaque or no drawable is set.
     *
     ...
     * the drawable is opaque or no drawable is set.
     *
     * @param fillColorRes The color resource to be resolved to a color and drawn behind the
     * drawable
