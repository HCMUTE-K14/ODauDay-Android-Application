...
public class MapListToggleButton extends RelativeLayout {
    ...
    private void bindView(View rootView) {
        ...
        mMapListButton = (RelativeLayout) rootView.findViewById(R.id.btn_toggle_map_list);
        mImageView = (ImageView) rootView.findViewById(R.id.image_btn);
        mTextView = (TextView) rootView.findViewById(R.id.text_btn);
    }
    ...
    private void addListener() {
        ...
        mMapListButton.setOnClickListener(view -> {
            changeState();
        });
    }
